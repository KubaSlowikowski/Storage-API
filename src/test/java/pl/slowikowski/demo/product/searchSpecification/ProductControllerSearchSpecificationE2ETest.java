...
//class ProductControllerSearchSpecificationE2ETest {
//    @Autowired
...
////
////        ResponseEntity<RestResponsePage<Product>> result = restTemplate.exchange(URL_PREFIX + "price>50", HttpMethod.GET, null/*httpEntity*/, responseType);
////
////        List<Product> results = result.getBody().getContent();
//
